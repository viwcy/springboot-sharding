...
/**
 * <p>Title: ShardingTableAlgorithmConfig</p>
 * <p>Description: ShardingTableAlgorithmConfig</p>
 * <p>Copyright: Xi An BestTop Technologies, ltd. Copyright(c) 2018/p>
 *
 * @author Fuqiang
 * @version 0.0.0.1
 * <pre>Histroy:
 *       2020/4/8 0008 9:46 Create by Fuqiang
 * </pre>
 * <p>
 * <p>
 * TODO     分表算法实现
 */
@Configuration
public class ShardingBookTableConfig implements PreciseShardingAlgorithm<String> {
    ...
    public String doSharding(Collection<String> availableTargetNames, PreciseShardingValue<String> shardingValue) {
        for (String availableTargetName : availableTargetNames) {
            ...
            //shardingValue.getLogicTableName()是逻辑表名
